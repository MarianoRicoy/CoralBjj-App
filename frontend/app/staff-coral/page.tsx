...
export const metadata: Metadata = {
  title: "Staff Coral",
  description:
    "Staff de Coral BJJ Studio: profesores e instructores que sostienen la formación técnica y humana de la academia.",
};

const PLACEHOLDERS = Array.from({ length: 6 }, (_, i) => i);

export default function StaffCoralPage() {
  return (
    <main className="relative flex-1 overflow-x-hidden">
      <div className="relative mx-auto max-w-6xl px-6 py-20 md:py-28 lg:py-36">
        ...
        <p className="mb-12 max-w-2xl font-tertiary text-lg leading-[1.8] text-zinc-300 md:mb-16 md:text-xl">
          El equipo que sostiene la formación técnica y humana de Coral.
          Profesores e instructores que transmiten la línea de la academia con
          estándar, cercanía y compromiso.
        </p>
